...
# Print the results
print(f"Walt Disney (DIS) Current Stock Price: {S:.2f}")
...
# Walt Disney (DIS) Current Stock Price: 82.35
# Strike Price: 90
# Time to Expiration (years): 1.10
# Risk-Free Interest Rate: 0.05
# Volatility: 0.32
# Call Option Price: 6.78
# Put Option Price: 11.35